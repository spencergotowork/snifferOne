    ...
    public partial class CaptureForm : Form
    {
        ...
        private void Shutdown()
        {
            if (device != null)
            {
                ...
                startStopToolStripButton.Image = global::WinformsMain.Properties.Resources.play_icon_enabled;
        ...
        private void StartCapture(int itemIndex)
        {
            ...
            ////这里加一个测试，filter的过滤
            device.Filter = WinformsExample.PcapFilter.total_filter;
            ...
            startStopToolStripButton.Image = global::WinformsMain.Properties.Resources.stop_icon_enabled;
